...
document.onkeypress = function(event) {
	...
	var html = "<p><h1>Spooky Psychic Game</h1></p>" + "<p><h2>Read My Mind: Guess The Letter</h2></p>" + "<p><h2>Wins: " + win + "</h2></p>" + "<p><h2>Losses: " + loss + "</h2></p>" + "<p><h2>Guesses Remaing: " + guessesRemaining + "</h2></p>" + "<p><h2>Your guesses so far: " + guessesWrong + "</h2></p>";
